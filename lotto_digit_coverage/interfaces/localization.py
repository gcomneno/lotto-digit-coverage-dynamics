...
_ENGLISH_CATALOG: Mapping[str, str] = {
    ...
    "cli.ask.status_label": "Status",
    "cli.ask.interpretation_label": "Normalized interpretation",
    "cli.ask.query_label": "Validated query",
    "cli.ask.reason_label": "Reason",
    "cli.ask.results_label": "Results",
    "cli.ask.no_rows": "No rows.",
...
_ITALIAN_CATALOG: Mapping[str, str] = {
    ...
    "cli.ask.status_label": "Stato",
    "cli.ask.interpretation_label": "Interpretazione normalizzata",
    "cli.ask.query_label": "Query validata",
    "cli.ask.reason_label": "Motivo",
    "cli.ask.results_label": "Risultati",
    "cli.ask.no_rows": "Nessun risultato.",
    "cli.ask.database_label": "Database",
