...
const ENGLISH_CATALOG: Catalog = {
  ...
  'research.eyebrow': 'Historical analyses',
  'research.title': 'Research reports',
  'research.intro': 'Reports are calculated on demand by the same application services used by the laboratory. The GUI displays structured results and does not execute or interpret CLI output. Each report retains its descriptive or exploratory nature.',
  'research.catalog_unavailable': 'Research catalog is unavailable.',
  'research.report_unavailable': 'Research report is unavailable.',
  'research.loading_catalog': 'Loading research catalog…',
  'research.catalog_label': 'Report catalog',
  'research.catalog': 'Catalog',
  'research.calculating': 'Calculating…',
  'research.recalculate': 'Recalculate',
  'research.open': 'Open',
  'research.calculation_in_progress': 'Calculation in progress…',
  'research.calculation_core': 'The report is being built in the Python core.',
  'research.source': 'Source',
  'research.twins_filters': 'Twin table filters',
  'research.condition': 'Condition',
  'research.all_feminine': 'All',
  'research.twin': 'Twin',
  'research.all_masculine': 'All',
  'research.candidates_only': 'Exploratory candidates only',
  'research.rows_shown_out_of': 'rows shown out of',
  'research.candidate': 'CANDIDATE',
  'research.no_filtered_rows': 'No rows match the selected filters.',
  'research.interpretation_limits': 'Interpretation and limits',
  'research.choose_report': 'Choose a report from the catalog',
  'research.on_demand': 'Calculation starts only when you request it.',
};
...
const ITALIAN_CATALOG: Catalog = {
  ...
  'research.eyebrow': 'Analisi storiche',
  'research.title': 'Research reports',
  'research.intro': 'I report vengono calcolati on demand dagli stessi application service usati dal laboratorio. La GUI visualizza risultati strutturati e non esegue o interpreta output CLI. Ogni scheda mantiene la propria natura descrittiva o esplorativa.',
  'research.catalog_unavailable': 'Catalogo ricerca non disponibile.',
  'research.report_unavailable': 'Report di ricerca non disponibile.',
  'research.loading_catalog': 'Caricamento del catalogo di ricerca…',
  'research.catalog_label': 'Catalogo report',
  'research.catalog': 'Catalogo',
  'research.calculating': 'Calcolo…',
  'research.recalculate': 'Ricalcola',
  'research.open': 'Apri',
  'research.calculation_in_progress': 'Calcolo in corso…',
  'research.calculation_core': 'Il report viene costruito nel core Python.',
  'research.source': 'Sorgente',
  'research.twins_filters': 'Filtri tabella gemelli',
  'research.condition': 'Condizione',
  'research.all_feminine': 'Tutte',
  'research.twin': 'Gemello',
  'research.all_masculine': 'Tutti',
  'research.candidates_only': 'Solo candidati esplorativi',
  'research.rows_shown_out_of': 'righe visualizzate su',
  'research.candidate': 'CANDIDATO',
  'research.no_filtered_rows': 'Nessuna riga corrisponde ai filtri selezionati.',
  'research.interpretation_limits': 'Interpretazione e limiti',
  'research.choose_report': 'Scegli un report dal catalogo',
  'research.on_demand': 'Il calcolo parte soltanto quando lo richiedi.',
};
